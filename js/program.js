  ...
  pre: [
...

    {
      ...
      tracks: [
        ...
        {
          name: 'FATE', room: 'Room 4',
          subtitle: 'Focused Assessed Transthoracic Echocardiography',
...

    {
      ...
      tracks: [
        { name: 'Regional Anaesthesia Workshop', room: 'Room 1', faculty: ["Dr. Caxton Ng'ang'a", 'Dr. Billow Mohammed'], sponsor: 'hatch',
        ...
        { name: 'FATE', room: 'Room 4', subtitle: 'Focused Assessed Transthoracic Echocardiography', faculty: ['Dr. Kevin Umani', 'Dr. Isaac Adembesa'],
